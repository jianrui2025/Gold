...
def get_realtime_quotes_dc(symbols="688553"):
    ...
    response = requests.get(url, headers=rtqv.dc_cookies, cookies=rtqv.dc_headers, params=params, verify=False)
    ...
    outside_pan = data_info["f49"] # 外盘累积成交量
    inside_pan = data_info["f161"] # 内盘累积成交量
...
if __name__ == '__main__':
    ...
    df = get_realtime_quotes_dc(symbols="518880")
